...
<template>
  <div class="mx-auto max-w-screen-xl px-4 bg-[#b32929]">
    ...
    <div v-else class="flex flex-wrap justify-center xl:justify-start md:justify-start lg:justify-start gap-x-[1%] gap-y-[20px]">
      <div
        ...
        class="relative flex flex-col items-center basis-[100%] md:basis-[49.44%] bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-[100%] dark:border-gray-700 dark:bg-gray-800"
      >
        <img
        ...
        <div class="flex flex-col justify-between p-4 leading-normal h-full">
          ...
          <div
            class="py-2" v-for="(stat, idx) in pokemon.stats"
            :key="idx"
          >
          ...
          <div class="flex mt-4 md:mt-4 gap-3">
            ...
            <button
              ...
              class="font-medium inline-flex items-center px-4 py-2 text-sm text-center rounded-lg focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
            >Remove</button>
          </div>
        </div>
      </div>
